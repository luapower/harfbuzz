...
--buffers (user-allocated objects with a destructor)
...
ffi.metatype('hb_buffer_t', {__index = {
	...
	set_invisible_glyph = C.hb_buffer_set_invisible_glyph,
	get_invisible_glyph = C.hb_buffer_get_invisible_glyph,
